...
class PromptGenerator {
  ...
  getRandomElementWithIndex(array, keyIndex) {
    ...
    do {
      ...
      this.choiceRecord.prompts[key][selectedIndex] &&  // If already used
      Math.random() * 100 > this.reuseChanceIn100       // Roll fails
    );
   ...
   */
  setupEventListeners() {
    // Prevent the body click listener from interfering with the title link
